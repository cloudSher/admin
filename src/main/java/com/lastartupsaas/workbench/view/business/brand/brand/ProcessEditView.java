 ...
 * @date: 2016-12-13
 */
@SpringView(name = ProcessEditView.VIEW_NAME)
public class ProcessEditView extends BaseWorkBenchEditorView {

	private static final long serialVersionUID = -6988035636640799778L;
	public static final String VIEW_NAME = "process_edit.view";
	...
	protected void declareFormAgent(FormAgent formAgent) {
		...
		intention_gold.add(new FormField("意向金范围", "intention_gold", InputFieldEditor.class, true, null, true).setInputDescr("(500-2000元)"));
		...
		process_first_stage.add(new FormField("第一阶段", "first_stage", new CheckboxMultilevelGroupEditor(first_stage, "key", "value", "vertical"), true,
				null, true));
		...
		process_third_stage.add(new FormField("第三阶段", "third_stage", new CheckboxMultilevelGroupEditor(third_stage, "key", "value", "vertical"), true,
				null, true));
