 ...
 *
 */
public class RadioboxGroupFieldEditor extends BaseFormFieldEditor {
	...
	public RadioboxGroupFieldEditor() {
	}
	
	public RadioboxGroupFieldEditor(List<?> items, String valuePropertyName, String displayPropertyName) {
		super();
		this.items = items;
